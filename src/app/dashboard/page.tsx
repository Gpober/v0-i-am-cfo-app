...
export default function MobileResponsiveFinancialsPage() {
            ...
            <div>
              ...
              <div className="mt-2 text-sm text-gray-600">
                ...
                <div className="mt-1 text-xs text-green-600">
                  ✅ P&L accounts automatically classified • Balance Sheet accounts excluded • 🏗️ Account grouping
                  enabled
                </div>
              </div>
            </div>
          ...
          <div className="sticky top-0 bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4 z-10">
            <div className="flex justify-between items-center">
              <div>
                ...
                <div className="text-sm opacity-90">{timePeriod} • All Properties Combined</div>
              </div>
              <button
            ...
            <div className="mt-4 grid grid-cols-4 gap-4 text-center">
              ...
              <div>
                ...
                <div
                  className={`text-lg font-bold ${kpis.netOperatingIncome >= 0 ? "text-green-200" : "text-red-200"}`}
                >
                  {formatCompactCurrency(kpis.netOperatingIncome)}
                </div>
              </div>
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-4 space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-blue-600">{formatCurrency(kpis.grossProfit)}</span>
              </div>
              <div className="flex justify-between items-center">
  ...
  const renderMobileFilters = () => (
    <div
      className={`${mobileFilterOpen ? "block" : "hidden"} lg:hidden absolute top-full right-0 bg-white border border-gray-200 rounded-lg shadow-lg z-50 p-4 space-y-4`}
                      ...
                      >
                        <div className="flex-1 min-w-0">
                          ...
                          {account.account_detail_type && (
                            <div className="text-xs text-gray-500 truncate">{account.account_detail_type}</div>
                          )}
                        </div>
                        <div className="ml-3 text-right">
                          <div className={`font-medium ${account.total >= 0 ? "text-green-600" : "text-red-600"}`}>
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <div className="text-sm text-gray-600">
                  {selectedAccountDetails.entries?.length || 0} transactions •{" "}
