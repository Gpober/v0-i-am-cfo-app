    ...
    <div className="bg-white rounded-xl shadow-sm overflow-hidden">
      <div className="p-4 border-b border-gray-200">
        <div className="flex justify-between items-center">
          ...
          {/* Toggle Buttons for Revenue/COGS/GP/Expenses/NI */}
          <div className="flex rounded-lg border border-gray-300 overflow-hidden">
            <button
            ...
            {(() => {
              ...
              return hasCOGS ? (
                <button
                  ...
                  style={{ backgroundColor: propertyChartMetric === 'cogs' ? BRAND_COLORS.warning || '#f59e0b' : undefined }}
                >
                  COGS
                </button>
              ) : null;
            ...
            <button
              ...
              style={{ backgroundColor: propertyChartMetric === 'expenses' ? BRAND_COLORS.danger || '#ef4444' : undefined }}
            >
              Expenses
            </button>
        ...
        <div className="text-sm text-gray-600 mt-2">
          {propertyChartMetric === 'income' ? 
            ...
            propertyChartMetric === 'gp' ?
            `Gross Profit (Revenue - COGS) breakdown by property for ${timePeriod} period` :
            propertyChartMetric === 'expenses' ?
            `Total Expenses breakdown by property for ${timePeriod} period` :
            `Net Income breakdown by property for ${timePeriod} period`
          }
          {viewMode === 'by-property' && (
                  ...
                  content={({ active, payload }) => {
                    if (active && payload && payload.length > 0) {
                      ...
                      const metricName = propertyChartMetric === 'income' ? 'Revenue' :
                                       ...
                                       propertyChartMetric === 'expenses' ? 'Total Expenses' : 'Net Income';
