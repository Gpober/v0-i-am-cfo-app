    ...
    <div className="p-4">
      {selectedAccountDetails ? (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 p-3 bg-gray-50 rounded-lg">
            <div>
              ...
              <div className="text-base font-semibold">{selectedAccountDetails.entries?.length || 0}</div>
            </div>
            <div>
              <span className="text-xs text-gray-500">P&L Category</span>
              <div className="text-base font-semibold">{selectedAccountDetails.category}</div>
            </div>
          </div>
        ...
        <div className="text-center text-gray-500 py-8">
          Select an account to view transaction details
        </div>
      )}
    </div>
  </div>
